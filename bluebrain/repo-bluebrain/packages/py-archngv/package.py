...
class PyArchngv(PythonPackage):
    ...
    depends_on("py-libsonata@0.1.8:0.99", type=("build", "run"))
    ...
    depends_on("spatial-index@0.4.2:0.99", type=("build", "run"))
    depends_on("py-bluepy-configfile@0.1.11:", type=("build", "run"))
    depends_on("py-click@7.0:7.99", type=("build", "run"))
    depends_on("py-numpy-stl@2.10:2.99", type=("build", "run"))
    depends_on("py-openmesh@1.1.2:1.99", type=("build", "run"))
    depends_on("py-pyyaml@5.0:5.99", type=("build", "run"))
    depends_on("py-pandas@1.1.0:1.99", type=("build", "run"))
    ...
    depends_on("snakemake@5.0:5.99", type=("build", "run"))
    ...
    depends_on("py-dask+distributed+bag@2.0:2.99", type=("build", "run"))
    depends_on("py-distributed@2.0:2.99", type=("build", "run"))
    depends_on("py-dask-mpi@2.0:2.99", type=("build", "run"))
