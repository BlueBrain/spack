...
class PyNexusforge(PythonPackage):
    ...
    depends_on('python@3.5:', when='@0.6.3', type=('build', 'run'))
    depends_on('python@3.7:', when='@0.7.0', type=('build', 'run'))
    ...
    depends_on('py-pyshacl@0.11.6.post1', when='@0.6.3', type=('build', 'run'))
    depends_on('py-pyshacl@0.17.2', when='@0.7.0', type=('build', 'run'))
    depends_on('py-rdflib@:5.999', when='@0.6.3', type=('build', 'run'))
    depends_on('py-rdflib@6.0.0:', when='@0.7.0', type=('build', 'run'))
    depends_on('py-rdflib-jsonld@:0.6.099', when='@0.6.3', type=('build', 'run'))
    depends_on('py-nest-asyncio@1.5.1:', type=('build', 'run'))
    depends_on('py-owlrl@5.2.3:', when='@0.7.0', type=('build', 'run'))
    depends_on('py-pyparsing@2.0.2:', when='@0.7.0', type=('build', 'run'))
    depends_on('py-elasticsearch-dsl@7.4.0:', when='@0.7.0', type=('build', 'run'))
