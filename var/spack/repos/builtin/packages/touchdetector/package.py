...
class Touchdetector(CMakePackage):
    ...
    version('4.3.4', tag='v4.3.4', git=url, preferred=True submodules=True)
    version('4.3.3', commit='e3a313e2c4', git=url, submodules=True)
    version('4.3.2', commit='8b52245181', git=url, submodules=True)
