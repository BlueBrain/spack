...
class PyRegionGrower(PythonPackage):
    ...
    version('0.3.0', tag='region-grower-v0.3.0.dev0')
    ...
    depends_on('py-morphio@3.0:3.999', type='run', when='@0.3.0:')
    depends_on('py-morphio@2.7:2.99', type='run', when='@:0.2.99')
    depends_on('py-neuroc@0.2.8:', type='run', when='@0.3.0:')
    ...
    depends_on('py-morph-tool@2.8.0:', type='run', when='@0.3.0:')
    depends_on('py-morph-tool@:2.7.99', type='run', when='@:0.2.99')
