...
class PyIpyparallel(PythonPackage):
    ...
    depends_on('py-ipython@:6.999', type='run', when='^python@:2.999')
    depends_on('py-ipython', type='run', when='^python@3.6.5')
    depends_on('py-ipykernel@:4.999', type='run', when='^python@:2.999')
    depends_on('py-ipykernel', type='run', when='^python@3:')
    depends_on('py-futures', type='run', when='^python@:2.999')
