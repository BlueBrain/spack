...
class Brainbuilder(PythonPackage):
    ...
    depends_on('py-morphio@3.0.0:3.999', type='run')

    depends_on('py-attrs@:19.999', type='run')
    depends_on('py-entity-management@0.1.11:0.999', type='run')
    depends_on('py-subcellular-querier@0.0.3:', type='run')
