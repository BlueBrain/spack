...
class PyXgboost(PythonPackage):
    ...
    version("1.7.6", sha256="1c527554a400445e0c38186039ba1a00425dcdb4e40b37eed0e74cb39a159c47") # FIXME
    ...
    for ver in ["1.3.3", "1.5.2", "1.6.1", "1.6.2", "1.7.6"]:
        depends_on("xgboost@" + ver, when="@" + ver)

    depends_on("python@3.8:", when="@1.7:", type=("build", "run"))
