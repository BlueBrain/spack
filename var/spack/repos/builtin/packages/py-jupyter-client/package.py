...
class PyJupyterClient(PythonPackage):
    ...
    version('5.3.1', '93544fa47d36efb26864e3e211cac0f8')
    ...
    depends_on('py-setuptools', type='build', when='@5.3:')
    depends_on('py-traitlets', type=('build', 'run'))
    depends_on('py-jupyter-core', type=('build', 'run'))
    depends_on('py-zmq@13:16', type=('build', 'run'), when='@:4')
    depends_on('py-zmq@13:', type=('build', 'run'), when='@5.3:')
    depends_on('py-dateutil', type=('build', 'run'), when='@5.3:')
    depends_on('py-tornado@6:', type=('build', 'run'), when='@5.3:')
    depends_on('py-entrypoints', type=('build', 'run'), when='@5.3:')
