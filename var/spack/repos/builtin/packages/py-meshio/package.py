...
class PyMeshio(PythonPackage):
    ...
    version("5.3.5", sha256="f21f01abd9f29ba06ea119304b3d39e610421cfe93b9dd23362834919f87586d")
    ...
    depends_on("python@3.8:", when="@5.3.5:", type=("build", "run"))
    depends_on("python@3.7:", when="@5.0.0:", type=("build", "run"))
    depends_on("python@3.6:", type=("build", "run"))
    depends_on("py-setuptools@42:", type="build")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-numpy@1.20.0:", when="@5.3.5:", type=("build", "run"))
    depends_on("py-rich", when="@5.3.5:", type=("build", "run"))
