...
class PyIpykernel(PythonPackage):
    ...
    url      = "https://pypi.io/packages/source/i/ipykernel/ipykernel-5.1.2.tar.gz"

    version('5.1.2', sha256='b503913e0b4cce7ed2de965457dfb2edd633e8234161a60e23f2fe2161345d12')
    ...
    depends_on('py-ipython@:5', when='@:4.999', type=('build', 'run'))
    depends_on('py-ipython@7:', when='@5.0.0:', type=('build', 'run'))
